...
namespace Nmap.NET.Test
{
    ...
    public class NdiffUnitTests
    {
        ...
        [TestMethod]
        public void DiffTwoNmapTextOutputFilesGoodFiles()
        {
        ...
        [TestMethod]
        public void DiffTwoNmapTextVerboseOutputFilesGoodFiles()
        {
            var file1 = Path.Combine(TestFileDir, "scanme.nmap.org.xml");
            var file2 = Path.Combine(TestFileDir, "scanme.nmap.org_modified.xml");
            ...
            var options = new NdiffOptions
            {
                { NdiffFlag.Verbose, string.Empty },
                { NdiffFlag.Text, string.Empty }
            };
            ...
            Assert.AreEqual(output, " Nmap 7.60 scan initiated Wed Dec 06 03:06:28 2017 as: nmap -T4 -A -v scanme.nmap.org\r\n\r\n scanme.nmap.org (45.33.32.156):\r\n Host is up.\r\n Not shown: 994 closed ports\r\n PORT     STATE    SERVICE      VERSION\r\n-22/tcp   open     ssh          OpenSSH 6.6.1p1 Ubuntu 2ubuntu2.8 (Ubuntu Linux; protocol 2.0)\r\n 25/tcp   filtered smtp\r\n 80/tcp   open     http         Apache httpd 2.4.7 ((Ubuntu))\r\n 110/tcp  filtered pop3\r\n 445/tcp  filtered microsoft-ds\r\n 9929/tcp open     nping-echo   Nping echo\r\n");
        }

        [TestMethod]
        public void DiffTwoNmapXmlOutputFilesGoodFiles()
        {
            var file1 = Path.Combine(TestFileDir, "scanme.nmap.org.xml");
            var file2 = Path.Combine(TestFileDir, "scanme.nmap.org_modified.xml");
        ...
        [TestMethod]
        public void DiffTwoNmapXmlVerboseOutputFilesGoodFiles()
        {
            var file1 = Path.Combine(TestFileDir, "scanme.nmap.org.xml");
            var file2 = Path.Combine(TestFileDir, "scanme.nmap.org_modified.xml");
